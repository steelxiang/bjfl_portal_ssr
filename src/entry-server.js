...
function getHtmlInfo(url, router) {
  let globalTitle  = globalThis?.globalTitleKeywordsDescription?.title
  let globalKeywords  = globalThis?.globalTitleKeywordsDescription?.keywords
  let globalDescription  = globalThis?.globalTitleKeywordsDescription?.description
  ...
  return {
    lang,
    title: url.includes("/reports/") ? globalTitle : title,
    keywords: url.includes("/reports/") ? globalKeywords + "、"+ keywords : keywords,
    desc: url.includes("/reports/") ? globalDescription : desc,
  }
}
